...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/tests-154-brightgreen" alt="154 tests">
</p>
...
Clean-architecture layering, with every layer in its own framework module generated by [Tuist](https://tuist.dev). Dependencies point inward only — `Domain` knows nothing about the frameworks around it. Modules are dynamic frameworks marked mergeable: Debug builds link them dynamically for fast incremental builds, Release builds merge them into the app binary.
